classdef building
    ...
    methods
        function obj = building(building_name,P_ess1,ts,T_des_lower1, T_des_upper1, heating_set_points1, cooling_set_points1)
            ...
            obj.heating_set_points = heating_set_points; 
            obj.cooling_set_points = cooling_set_points;
            obj.time = 60;
            obj.ep = mlep;
            ...
            y = y(:);
            obj.ac_state_hist(obj.time/60,:) = ones(1,obj.noH);
            obj.T_in_hist(obj.time/60,:) = y(1:3:72,1)';
            obj.Phvac_hist(obj.time/60,:) = (y(2:3:72,1)' + y(3:3:72,1)');
        ...
        function output = run(obj,controls)
            ...
            [y,obj.time] = obj.ep.read;     % Get EnergyPlus outputs 
            y = y(:);
            obj.ac_state_hist(obj.time/60,:) = controls;
            obj.T_in_hist(obj.time/60,:) = y(1:3:72,1)';
            obj.Phvac_hist(obj.time/60,:) = (y(2:3:72,1)' + y(3:3:72,1)').*obj.ac_state_hist(t/60,:) +...
                     obj.Phvac_hist(obj.time/60-1,:) .*(1-obj.ac_state_hist(t/60,:));
